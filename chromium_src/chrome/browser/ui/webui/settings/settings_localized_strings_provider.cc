...
void BraveAddCommonStrings(content::WebUIDataSource* html_source,
  ...
  // Search settings
    ...
    {"adblockAddCustomFiltersListsLabel", IDS_BRAVE_ADBLOCK_ADD_CUSTOM_FILTERS_LISTS_LABEL},
    {"adblockAddCustomFiltersListsDesc", IDS_BRAVE_ADBLOCK_ADD_CUSTOM_FILTERS_LISTS_DESC},
    ...
    {"adblockFilterListsTableUrlHeader", IDS_BRAVE_ADBLOCK_FILTER_LISTS_TABLE_URL_HEADER},
    {"adblockFilterListsTableUpdatedHeader", IDS_BRAVE_ADBLOCK_FILTER_LISTS_TABLE_UPDATED_HEADER},
    {"adblockUpdateNowButtonLabel", IDS_BRAVE_ADBLOCK_UPDATE_NOW_BUTTON_LABEL},
    {"adblockViewSourceButtonLabel", IDS_BRAVE_ADBLOCK_VIEW_SOURCE_BUTTON_LABEL},
    {"adblockUnsubscribeButtonLabel", IDS_BRAVE_ADBLOCK_UNSUBSCRIBE_BUTTON_LABEL},
