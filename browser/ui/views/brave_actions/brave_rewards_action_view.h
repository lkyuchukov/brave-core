...
class BraveRewardsActionView
 ...
 private:
  ...
  void OnPublisherInfoReady(ledger::mojom::PublisherBannerPtr publisher);
  ...
  std::string GetPublisherIdForActiveTab();
  bool ShouldShow();
  void UpdateTabHelperObservation(content::WebContents* web_contents);
  ...
  std::pair<std::string, bool> publisher_verified_;
  brave_rewards::RewardsTabHelper::Observation tab_helper_observation_{this};
  brave_rewards::RewardsPanelService::Observation panel_service_observation_{
      this};
