...
class SearchResultAdRendererThrottle : public blink::URLLoaderThrottle {
 public:
  ...
  MaybeCreateThrottle(int render_frame_id, const blink::WebURLRequest& request);
  ...
  SearchResultAdRendererThrottle(const SearchResultAdRendererThrottle&) = delete;
  SearchResultAdRendererThrottle& operator=(const SearchResultAdRendererThrottle&) = delete;
 ...
 private:
  void OnMaybeTriggerAdViewConfirmation(
