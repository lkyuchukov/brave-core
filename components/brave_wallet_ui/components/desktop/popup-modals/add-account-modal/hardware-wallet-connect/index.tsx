...
export const HardwareWalletConnect = (props: Props) => {
  ...
  }, [onConnectHardwareWallet, selectedHardwareWallet, selectedAccountType])
  ...
  }, [accounts, selectedDerivationPaths, onAddHardwareAccounts])
  ...
  const onSubmit = React.useCallback(() => {
    ...
    onConnectHardwareWallet({
      ...
      stopIndex: accounts.length + DERIVATION_BATCH,
  ...
  }, [onConnectHardwareWallet, selectedHardwareWallet, accounts, selectedDerivationScheme, selectedAccountType])
